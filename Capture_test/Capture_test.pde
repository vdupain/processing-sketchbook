...
void setup() {
  ...
  //pipeline = new GSPipeline(this, "filesrc location=/Users/vince/Movies/big_buck_bunny_480p_stereo.ogg ! oggdemux ! theoradec");  
  //pipeline = new GSPipeline(this, "filesrc location=/Users/vince/Movies/test.mov ! decodebin");  
  pipeline = new GSPipeline(this, "rtspsrc location=rtsp://192.168.1.150:8086 decodebin");  
