...
String camParaPath = "/Users/vince/dev/processing/NyAR4psg/data/camera_para.dat";
...
void setup() { // fonction d'initialisation exécutée 1 fois au démarrage
  ...
  pipe = new GSPipeline(this, "souphttpsrc location=http://192.168.1.150:8080/videofeed do-timestamp=true is-live=true  ! multipartdemux ! jpegdec ! ffmpegcolorspace");  
